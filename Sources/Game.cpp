...
// TODO: 弾のスピードを速くし、弾が画面右端を通り越したら再度発射可能にする。(D) hw16a045 掛樋勇斗
// TODO: スコアのサイズを大きくする。(E) hw16a045 掛樋勇斗
// TODO: スコアを100点ずつ加算するようにし、5桁の表示に変える。(F) hw16a045 掛樋勇斗
